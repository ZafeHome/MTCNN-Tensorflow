...
7. After training **PNet**, run `gen_hard_example.py --test-mode PNet` to generate training data(Face Detection Part) for **RNet**.
...
11. After training **RNet**, run `gen_hard_example.py --test-mode RNet` to generate training data(Face Detection Part) for **ONet**.
